...
*/
  ...
  */
  ...
  static class CALL_CENTER_TBL {
    ...
    char[] cc_name = new char[RS_CC_NAME + 1];
    String cc_class;
    int                 cc_employees;
    int                 cc_sq_ft;
    String cc_hours;
    char[]              cc_manager = new char[RS_CC_MANAGER + 1];
    int                 cc_market_id;
    char[] cc_market_class = new char[RS_CC_MARKET_CLASS + 1];
    char[]      cc_market_desc = new char[RS_CC_MARKET_DESC + 1];
    char[]              cc_market_manager = new char[RS_CC_MARKET_MANAGER + 1];
    int                 cc_division_id;
    String cc_division_name; // RS_CC_DIVISION_NAME
    int                 cc_company;
    char[]              cc_company_name = new char[RS_CC_COMPANY_NAME + 1];
    Address cc_address;
  ...
  int
  mk_w_call_center (Object row, long index)
  {
    int res = 0;
    int nSuffix,
        bFirstRecord = 0,
